function validate() {
  ...
  const confirmPassword = document.getElementById("confirmPassword"); // New line
  ...
  const confirmPasswordError = document.getElementById("confirmPasswordError"); // New line
